...
* **Tipe artikel secara eksplisit tidak diharapkan** — *meta-analyses and other forms of evidence synthesis are **typically not considered***
* **Aspek kebaruan yang ditawarkan kurang memadai** — harus *"address an issue that makes a difference in the way psychologists think"*; ekstensi inkremental tidak cukup kuat; penekanan pada **inovasi dalam tujuan penelitian dan desain**, bukan sekadar hasil penelitian
* **_Overclaiming_** — kesimpulan yang tidak terkalibrasi dengan bukti atau keterbatasan desain *"are more likely to be rejected"*
* **Ketidakcocokan antara desain dan tujuan** — antara *research aims* dan *research design*, atau antara *empirical results* dan *conclusions*
* **Tanda-tanda fleksibilitas dalam menganalisis data** — *signs of flexibility in data collection or analysis* (e.g., *p-hacking*, perubahan hipotesis *post hoc*)
* **Risiko tinggi *statistical inference error*** — *false positive/negative*, *inflated effect size*
:::
