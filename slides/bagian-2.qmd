...
Model klasik yang berguna: **CARS** (*Create A Research Space*, [Swales, 1990](https://marymount.edu/academics/wp-content/uploads/sites/3/2021/08/CARS-Model-of-Research-Introductions.pdf)) — *establish a territory <i class="fa-solid fa-circle-arrow-right"></i> establish a niche <i class="fa-solid fa-circle-arrow-right"></i> occupy the niche*.
:::
...
* Banyak naskah yang datanya bagus tapi *Discussion*-nya lemah <i class="fa-solid fa-circle-arrow-right"></i> ditolak atau diminta revisi mayor
...
* Prinsip: **satu kalimat per bagian** IMRAD
  * 1 kalimat <i class="fa-solid fa-circle-arrow-right"></i> latar belakang/konteks dan *research gap*
  * 1 kalimat <i class="fa-solid fa-circle-arrow-right"></i> pertanyaan penelitian / tujuan
  * 1–2 kalimat <i class="fa-solid fa-circle-arrow-right"></i> metode
  * 1–2 kalimat <i class="fa-solid fa-circle-arrow-right"></i> temuan utama
  * 1 kalimat <i class="fa-solid fa-circle-arrow-right"></i> implikasi/kesimpulan
...
## Menulis artikel penelitian = merayakan kesalahan🎉

![](libs/science_means.png){fig-align="center"}
...
::: {.incremental}
* *Scoping* dan *systematic review* punya masih punya tempat di komunitas ilmiah, tetapi kompetisinya ketat
...
* Sebelum menulis, lakukan **cek duplikasi**: apakah _review_ serupa sudah diterbitkan baru-baru ini?
  * Jika ya <i class="fa-solid fa-circle-arrow-right"></i> naskah Anda harus punya **nilai tambah** yang jelas
...
* Contoh *overselling* dalam *review articles*:
  * *"Belum ada penelitian yang membahas ini"* <i class="fa-solid fa-circle-arrow-right"></i> padahal ada, hanya belum dibaca dengan cermat
  * *"Penelitian ini memberikan bukti yang tidak terbantahkan bahwa X menyebabkan Y"* <i class="fa-solid fa-circle-arrow-right"></i> *review* bukan RCT, tidak bisa mengklaim hubungan kausalitas
  * *"Temuan penelitian ini akan menggegerkan dunia"* <i class="fa-solid fa-circle-arrow-right"></i> terlalu berlebihan untuk diklaim
